...
public class JerseyClient {
    ...
    public static final JerseyClient REST_CLIENT = new JerseyClient();
    public static final JerseyClient REST_CLIENT_WITH_RETRY_HANDLER = new JerseyClient(true);
    public static final JerseyClient REST_CLIENT_WITH_TIMEOUT = new JerseyClient(true, 5000, 5000);
    ...
    private JerseyClient(final boolean withRetryHandler) {
        client = config(withRetryHandler);
    }

    private JerseyClient(final boolean withRetryHandler, final int socketTimeout, final int connectionTimeout) {
