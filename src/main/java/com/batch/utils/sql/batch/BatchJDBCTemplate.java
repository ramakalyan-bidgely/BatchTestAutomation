...
//    }
    ...
    public static List<String> getEligibleBatchesList(Integer pilotId, String component, Boolean
            isNextBatchDependentOnPrev, Integer parallelBatchesIfIndependent) {
