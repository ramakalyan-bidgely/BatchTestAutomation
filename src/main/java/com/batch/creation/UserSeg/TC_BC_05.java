...
public class TC_BC_05 {
    ...
    void validate() throws IOException {
        ...
        String Dir = "D:\\TEST DATA\\TC_BC_05\\DATA_FILES";
        String[] data = Dir.split("\\\\");
        String fileName= data[data.length-1];
        // a file with wrong  naming convention is given to transfer files
        ...
        String jsonFilePath = "D:\\TEST DATA\\TC_BC_05\\input_config.json";
